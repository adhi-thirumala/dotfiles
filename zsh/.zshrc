...
source /home/adhi/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
...
export PATH="/home/adhi/.bun/bin:$PATH"
#compdef warp-cli
...
(panic)
_arguments "${_arguments_options[@]}" : \
'--ignored[The panic will test the classification feature and present as an ignored panic]' \
'--no-paginate[Disable automatic pagination]' \
'-h[Print help]' \
'--help[Print help]' \
&& ret=0
...
&& ret=0
    ...
    (qlog)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-debug-qlog-command-$line[1]:"
        case $line[1] in
            (enable)
_arguments "${_arguments_options[@]}" : \
'--current-connection-only[If provided, qlogs will only be enabled for the current connection. This will not cause a reconnection to occur]' \
'--no-paginate[Disable automatic pagination]' \
'-h[Print help]' \
'--help[Print help]' \
&& ret=0
...
(help)
_arguments "${_arguments_options[@]}" : \
":: :_warp-cli__debug__qlog__help_commands" \
"*::: :->help" \
&& ret=0
    ...
    (help)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-debug-qlog-help-command-$line[1]:"
        case $line[1] in
            (enable)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
&& ret=0
    ...
    (qlog)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-debug-help-qlog-command-$line[1]:"
        case $line[1] in
            (enable)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
'*-g+[Group statistics by specified labels (comma-separated)]:GROUP_BY:_default' \
'*--group-by=[Group statistics by specified labels (comma-separated)]:GROUP_BY:_default' \
'--no-paginate[Disable automatic pagination]' \
'-h[Print help]' \
'--help[Print help]' \
&& ret=0
...
&& ret=0
    ...
    (qlog)
        words=($line[1] "${words[@]}")
        (( CURRENT += 1 ))
        curcontext="${curcontext%:*:*}:warp-cli-help-debug-qlog-command-$line[1]:"
        case $line[1] in
            (enable)
_arguments "${_arguments_options[@]}" : \
&& ret=0
...
'panic:Force a daemon panic - only works in debug mode' \
...
'in-flight-requests:A hidden debug command to list in-flight API requests' \
...
(( $+functions[_warp-cli__debug__frequent-connection-stats_commands] )) ||
_warp-cli__debug__frequent-connection-stats_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug frequent-connection-stats commands' commands "$@"
}
...
(( $+functions[_warp-cli__debug__help__frequent-connection-stats_commands] )) ||
_warp-cli__debug__help__frequent-connection-stats_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug help frequent-connection-stats commands' commands "$@"
}
...
(( $+functions[_warp-cli__debug__help__in-flight-requests_commands] )) ||
_warp-cli__debug__help__in-flight-requests_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug help in-flight-requests commands' commands "$@"
}
...
_warp-cli__debug__help__qlog_commands() {
    local commands; commands=(
'enable:Enable QLOGs. This will restart the connection unless \`--current-connection-only\` is passed' \
'disable:Disable QLOGs. This will restart the connection' \
    )
    _describe -t commands 'warp-cli debug help qlog commands' commands "$@"
}
(( $+functions[_warp-cli__debug__help__qlog__disable_commands] )) ||
_warp-cli__debug__help__qlog__disable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug help qlog disable commands' commands "$@"
}
(( $+functions[_warp-cli__debug__help__qlog__enable_commands] )) ||
_warp-cli__debug__help__qlog__enable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug help qlog enable commands' commands "$@"
}
...
(( $+functions[_warp-cli__debug__in-flight-requests_commands] )) ||
_warp-cli__debug__in-flight-requests_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug in-flight-requests commands' commands "$@"
}
...
(( $+functions[_warp-cli__debug__qlog__disable_commands] )) ||
_warp-cli__debug__qlog__disable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug qlog disable commands' commands "$@"
}
(( $+functions[_warp-cli__debug__qlog__enable_commands] )) ||
_warp-cli__debug__qlog__enable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug qlog enable commands' commands "$@"
}
(( $+functions[_warp-cli__debug__qlog__help_commands] )) ||
_warp-cli__debug__qlog__help_commands() {
    local commands; commands=(
'enable:Enable QLOGs. This will restart the connection unless \`--current-connection-only\` is passed' \
'disable:Disable QLOGs. This will restart the connection' \
'help:Print this message or the help of the given subcommand(s)' \
    ...
    _describe -t commands 'warp-cli debug qlog help commands' commands "$@"
}
(( $+functions[_warp-cli__debug__qlog__help__disable_commands] )) ||
_warp-cli__debug__qlog__help__disable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug qlog help disable commands' commands "$@"
}
(( $+functions[_warp-cli__debug__qlog__help__enable_commands] )) ||
_warp-cli__debug__qlog__help__enable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug qlog help enable commands' commands "$@"
}
(( $+functions[_warp-cli__debug__qlog__help__help_commands] )) ||
_warp-cli__debug__qlog__help__help_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli debug qlog help help commands' commands "$@"
}
...
(( $+functions[_warp-cli__help__debug__frequent-connection-stats_commands] )) ||
_warp-cli__help__debug__frequent-connection-stats_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help debug frequent-connection-stats commands' commands "$@"
}
(( $+functions[_warp-cli__help__debug__in-flight-requests_commands] )) ||
_warp-cli__help__debug__in-flight-requests_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help debug in-flight-requests commands' commands "$@"
}
...
(( $+functions[_warp-cli__help__debug__qlog__disable_commands] )) ||
_warp-cli__help__debug__qlog__disable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help debug qlog disable commands' commands "$@"
}
(( $+functions[_warp-cli__help__debug__qlog__enable_commands] )) ||
_warp-cli__help__debug__qlog__enable_commands() {
    local commands; commands=()
    _describe -t commands 'warp-cli help debug qlog enable commands' commands "$@"
}
